...
const ExploreItem = ({color,name}:ExploreProps) => {
  return (
    <div style={{backgroundColor:color}} className={`w-[350px] h-[200px] rounded-lg  p-4 flex overflow-hidden justify-between cursor-pointer`}>
