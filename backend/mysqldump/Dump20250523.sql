...
--
-- Table structure for table `musicdatas`
--

DROP TABLE IF EXISTS `musicdatas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `musicdatas` (
  ...
  `music_url` text,
  `music_image` text,
  `music_duration` int DEFAULT NULL,
...
-- Dump completed on 2025-05-23 19:46:54
